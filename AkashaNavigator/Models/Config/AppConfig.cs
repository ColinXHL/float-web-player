...
#region Conversion Methods
    ...
    {
        return new HotkeyConfig { ActiveProfileName = "Default", AutoSwitchProfile = false,
                                  Profiles = new List<HotkeyProfile> { new HotkeyProfile {
                                      Name = "Default", ActivationProcesses = null, Bindings = CreateHotkeyBindings()
                                  } } };
    }
    ...
    private List<HotkeyBinding> CreateHotkeyBindings()
    {
        return new List<HotkeyBinding> {
            ...
            new HotkeyBinding { Key = HotkeyDecreaseOpacity, Modifiers = HotkeyDecreaseOpacityMod,
