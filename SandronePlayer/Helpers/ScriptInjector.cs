...
namespace SandronePlayer.Helpers
{
    /// <summary>
    /// WebView2 脚本注入管理器
    ...
    public static class ScriptInjector
    {
        ...
        /// CSS 嵌入资源名称
        /// </summary>
        private const string StylesResourceName = "SandronePlayer.Scripts.InjectedStyles.css";

        /// <summary>
        /// JS 嵌入资源名称
        /// </summary>
        private const string ScriptsResourceName = "SandronePlayer.Scripts.InjectedScripts.js";
